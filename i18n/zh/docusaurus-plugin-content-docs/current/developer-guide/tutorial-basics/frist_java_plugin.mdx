...
<project xmlns="http://maven.apache.org/POM/4.0.0"
  ...
  <repositories>
    <!-- 只有 SNAPSHOT 构建需要此仓库；正式版来自 Maven Central -->
    <repository>
...
- 如果 Maven 无法解析 `com.nukkit-mot:nukkit-mot:1.26.30-R1`，先检查网络连接；如果无法解析 `cn.nukkit:Nukkit:MOT-SNAPSHOT`，再检查仓库地址

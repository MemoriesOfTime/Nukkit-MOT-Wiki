...
- If Maven cannot resolve `com.nukkit-mot:nukkit-mot:1.26.40-R1`, check your network connection. If it cannot resolve `cn.nukkit:Nukkit:MOT-SNAPSHOT`, also re-check the repository URL.

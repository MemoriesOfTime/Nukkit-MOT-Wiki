...
### Main Constructors and Methods \{#main-constructors-and-methods}
...
### Example Usage \{#example-usage-permission}
...
### Example Usage \{#example-usage-banlist}
...
### Main Methods \{#main-methods-serveroperator}
...
### Example Usage \{#example-usage-serveroperator}
...
### Registering Permission Nodes with plugin.yml \{#registering-permission-nodes}

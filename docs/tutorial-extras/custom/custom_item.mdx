...
graph TD;
    ...
    textures -..-> texture_list["📄 texture_list.json"];
...
This is exactly how the demo plugin does it.

<details>
    <summary>
      Show the resources directory structure of [ExamplePlugin](https://github.com/MemoriesOfTime/ExamplePlugin-Maven/tree/master/src/main/resources)
    </summary>
```mermaid
graph TD;
    resources("📁 resources") --> assets("📁 assets");
    resources("📁 resources") --> pluginyml["📄 plugin.yml"];
    resources("📁 resources") -..-> language("📁 language");
    assets("📁 assets") --> RP("📁 resource_pack");
    RP --> textures("📁 textures");
    textures -..-> texture_list["📄 texture_list.json"];
    textures --> item_texture["📄 item_texture.json"];
    textures --> items("📁 items");
    items --> candy_cane_sword["📄 candy_cane_sword.png"];
    RP("📁 resource_pack") --> manifest["📄 manifest.json"];
    RP --> pack_icon["📄 pack_icon.png"];
```
</details>
